...
execute_process(
  COMMAND "/usr/bin/git" show-ref origin/release
  WORKING_DIRECTORY "/home/ciferri/Bureau/stage/v2/M2SLv0.1_EP/M2SLv0.1_EP/External-Projects/ITK"
...
if("${show_ref_output}" MATCHES "refs/remotes/origin/release")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "origin/release")
...
# yet).
execute_process(
  COMMAND "/usr/bin/git" rev-list --max-count=1 origin/release
  WORKING_DIRECTORY "/home/ciferri/Bureau/stage/v2/M2SLv0.1_EP/M2SLv0.1_EP/External-Projects/ITK"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'https://github.com/InsightSoftwareConsortium/ITK.git'")
  endif()
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/ciferri/Bureau/stage/v2/M2SLv0.1_EP/M2SLv0.1_EP/External-Projects/ITK/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/home/ciferri/Bureau/stage/v2/M2SLv0.1_EP/M2SLv0.1_EP/External-Projects/ITK/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
